...
function registerActive(){
  data.isLoginActive = false
  data.isRegisterActive = true
  data.errorMsg = ''
}
function loginActive(){
  data.isLoginActive = true
  data.isRegisterActive = false
  data.errorMsg = ''
}
...
function loginMatchData(){
  if(data.loginDetails.userName === data.validUserName && data.loginDetails.password === data.validPassword){
    data.isLoginActive = false
    data.isRegisterActive = false
    return data.isDashboardActive = true
  }else {
    data.errorMsg ='Please input valid User Name & Password'
  }
}
function userRegister(){
  if (''=== data.registerDetails.userName){
    data.errorMsg = 'User Name field is empty'
  }else if(data.registerDetails.password === data.registerDetails.retypePassword){
    data.validUserName = data.registerDetails.userName
    data.validPassword = data.registerDetails.password
    data.isLoginActive = true
    data.isRegisterActive = false
    data.isDashboardActive = false
    data.errorMsg = ''
  } else {
    data.errorMsg = 'Password and Retype Password does not match'
  }
}
function logout(){
  data.isDashboardActive = false
...
<template>
  <section>
    ...
    <div class="container mx-auto h-screen flex flex-col items-center justify-center" v-show="data.isDashboardActive">
      <h1 class="text-2xl p-8">You have logged in successfully!</h1>
      <button class="bg-indigo-500 text-gray-100 px-8 py-3 rounded
                                font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600
                                shadow-lg" @click="logout()">Logout</button>
    </div>
    <!--  Dashboard Section End  -->
    <!--  Login Section Start  -->
    <div v-show="data.isLoginActive">
      <div class="lg:flex" >
        <div class="lg:w-1/2 xl:max-w-screen-sm">
          <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
            <div class="cursor-pointer flex items-center">
              <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">Ostad</div>
            </div>
          </div>
          <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            <h2 class="text-red-600 text-xl text-center mb-10">{{ data.errorMsg }}</h2>
            ...
            <div class="mt-12">
              <form @submit.prevent>
                <div>
                  ...
                  <input v-model="data.loginDetails.userName" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="text" placeholder="Enter user name">
                </div>
                <div class="mt-8">
                  ...
                  <input v-model="data.loginDetails.password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="Enter your password">
                </div>
                <div class="mt-10">
                  <button @click="loginMatchData()" class="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                                font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600
                                shadow-lg">
                    Log In
                  </button>
              ...
              <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                Don't have an account ? <a @click="registerActive()" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign up</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div v-show="data.isRegisterActive">
      <div class="lg:flex">
        <div class="lg:w-1/2 xl:max-w-screen-sm">
          <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
            <div class="cursor-pointer flex items-center">
          ...
          <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            ...
            <div class="mt-12">
              <form @submit.prevent>
                <div>
                  <div class="text-sm font-bold text-gray-700 tracking-wide">User Name</div>
                  <input v-model="data.registerDetails.userName" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="text" placeholder="Enter user name">
                </div>
                <div class="mt-8">
                  <div class="flex justify-between items-center">
                    <div class="text-sm font-bold text-gray-700 tracking-wide">
                  ...
                  <input v-model="data.registerDetails.password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="*************">
                </div>
                <div class="mt-8">
                  <div class="flex justify-between items-center">
                    <div class="text-sm font-bold text-gray-700 tracking-wide">
                  ...
                  <input v-model="data.registerDetails.retypePassword" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="*************">
                </div>
                <div class="mt-10">
                  <button @click="userRegister()" class="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                                font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600
                                shadow-lg">
                    Register
                  </button>
              ...
              <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                Have an account ? <a @click="loginActive()" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign In</a>
              </div>
            </div>
          </div>
        </div>
